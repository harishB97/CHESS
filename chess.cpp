...
int main()
{
	...
	while(1)
	{
		...
		time_t t1 = time(0);	/*noting the time before search for best move starts*/
		...
		cout<<" END"<<endl;
		cout<<"MOVELABEL: "<<moveToMake<<" ; MOVEVALUE: "<<valueOfMoveMade<<" ; PIECE MOVED: "<<numLetter[move[moveToMake].piece]<<endl;
